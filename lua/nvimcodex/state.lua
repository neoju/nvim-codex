...
---Saves the state in the global _G.Nvimcodex.state object.
---
---@private
function state:save()
    log.debug("state.save", "saving state globally to _G.Nvimcodex.state")

    _G.Nvimcodex.state = self
end
...
---Whether the Nvimcodex is enabled or not.
---
